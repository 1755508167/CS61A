...
class Coin:
    ...
    def worth(self):
        ...
        # print('Mint.present_year',Mint.present_year)
        result = Mint.present_year - self.year
        # print('result',result)
        # print(type(result))
        if self.cents + result > 50:
            return self.cents + result - 50
        else:
            return self.cents
